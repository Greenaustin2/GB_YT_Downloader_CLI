...
if __name__ == "__main__":
    ...
    parser.add_argument('--format', dest='format', required=False, default='img')
    ...
    parser.add_argument('--number', dest='number', required=False, default=2157)
    parser.add_argument('--search_query', dest='search_query', required=False, default=2157)
